      ...
      <div className="max-w-[1700px] mx-auto space-y-6">
        <header className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#0A3A66] hover:bg-[#072a4a] text-white px-5 py-2.5 text-sm font-semibold border border-[#072a4a] shadow-md hover:shadow-lg transition-all"
          >
